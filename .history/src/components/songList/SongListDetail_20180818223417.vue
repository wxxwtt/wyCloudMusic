<template>
    <ul class="mui-table-view songlist">
      <router-link tag="li" :to="{name:'Player',query:{id:item.id}}" class="mui-table-view-cell" v-for="(item) in songList" :key="item.id" :songeName="item.name" :songer="item.ar[0].name">
